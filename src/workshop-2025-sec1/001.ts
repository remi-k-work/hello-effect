...
import type { ChildImmuneError, MalformedPunError, NoChannelAvailableError, NoTokenAvailableError, PunsterFetchError } from "./shared/domain/errors.js";
 ...
 */
export class PunsterClient extends Context.Tag("Punsterclient")<PunsterClient, PunsterClientShape>() {}
 ...
 */
export class PunDistributionNetwork extends Context.Tag("app/PunDistributionNetwork")<PunDistributionNetwork, PunDistributionNetworkShape>() {}
 ...
 */
export class ImmunityTokenManager extends Context.Tag("app/ImmunityTokenManager")<ImmunityTokenManager, ImmunityTokenManagerShape>() {}
