...
export const misbehaviors = [
  Misbehavior.make({
    ...
    severity: 5,
    description: "The beautiful Neovim configuration and editor setup provided " + "to Michael by Maxwell was severely underappreciated",
  }),
  Misbehavior.make({
    childName: "Sebastian Lorenz",
    category: "TooMuchTimeSpentOnEffectCronModule",
    severity: 2,
    description: "Spent way too much time agonizing over minutia while " + "designing the internals of Effect's Cron module",
  }),
  Misbehavior.make({
