 ...
 * distributing puns.
 */
export const ChannelType = Schema.Literal("DinnerConversation", "CarRide", "BedtimeRoutine", "FamilyGathering", "HomeworkSession").annotations({
 ...
 * puns.
 */
export const Receptivity = PositiveInt.pipe(Schema.between(1, 100)).annotations({ identifier: "Receptivity" });
...
export class Channel extends Schema.Class<Channel>("Channel")({
  ...
  static OrderReceptivityDesc = Order.mapInput(Order.number, (channel: Channel) => channel.receptivity);
